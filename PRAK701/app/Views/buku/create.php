...
<body>
    ...
    <form action="<?= base_url('buku/save') ?>" method="POST" class="form">
        <?= csrf_field() ?>
        ...
        <input type="text" class="form-control <?= isset($errors['penulis']) ? 'is-invalid' : '' ?>" id="penulis" name="penulis" value="<?= old('penulis') ?>">
        ...
        <input type="number" class="form-control <?= isset($errors['tahun_terbit']) ? 'is-invalid' : '' ?>" id="tahun_terbit" name="tahun_terbit" value="<?= old('tahun_terbit') ?>">
